  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-lg leading-relaxed">{guide.summary}</p>
      </div>

      {/* Call First — most prominent */}
      <div className="bg-red-600 text-white rounded-xl p-5 mb-8">
            ...
            >
              ...
              <p
                className={`text-sm leading-relaxed pt-0.5 ${
                  step.important ? "text-gray-900 font-medium" : "text-gray-700"
                }`}
              >
                {step.instruction}
              </p>
      ...
      {/* Print action */}
      <div className="border border-gray-200 rounded-xl p-4 flex items-center justify-between mb-10">
        <div>
